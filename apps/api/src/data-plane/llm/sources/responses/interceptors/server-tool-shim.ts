...
export type ServerToolRegistration = (ctx: ResponsesInvocation, request: RequestContext) => ServerToolPrepareResult | Promise<ServerToolPrepareResult>;
...
): ResponsesInterceptor => async (ctx, request, run) => {
